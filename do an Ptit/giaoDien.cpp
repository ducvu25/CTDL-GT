...
int menu(int d) {
    ...
    switch(d){
        case 0: {
            int size[] = { 30 };
            VeBang(setX, setY, tieuDe, size, 5, 1);
            dodai = 15;
            s[0] = "Menu";
            s[1] = "Quan ly mon hoc";
        ...
        case 1: {
            int size[] = { 28 };
            VeBang(setX, setY, tieuDe, size, 4, 1);
            dodai = 15;
            s[0] = "Quan ly mon hoc";
        ...
        case 2: {
            int size[] = { 36 };
            VeBang(setX, setY, tieuDe, size, 7, 1);
            dodai = 18;
        ...
        case 3: {
            int size[] = { 36 };
            VeBang(setX, setY, tieuDe, size, 6, 1);
            dodai = 18;
    ...
    for (int i = 0; i < n; i++) {
        gotoXY(setX + dodai - s[i].size() / 2, setY + 2 * i + 1);
        cout << s[i];
    }
    TextColor(setColorMenu1);
    gotoXY(setX + dodai - s[1].size() / 2, setY + 2 + 1);
    cout << s[1];
    ...
    while (1) {
        if (kbhit()) {
            ...
            TextColor(setColorMenu1);
            gotoXY(setX + dodai - s[dk].size() / 2, setY + 2 * dk + 1);
            cout << s[dk];
        }
    }
}
